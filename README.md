...
## Функциональность
В проекте можно добавить изображение с названием в список, удалить из своего списка добавленных, либо открыть его в полном разрешении.
Для входа в свой аккаунт для начала необходимо зарегистрироваться, а после регистрации авторизоваться. После чего автоматически переведётесь на страницу списка карточек с изображением. 
